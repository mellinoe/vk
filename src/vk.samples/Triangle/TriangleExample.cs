...
namespace Vk.Samples
{
    public unsafe class TriangleExample : VulkanExampleBase
    {
        ...
        {
            Debug.Assert(commandBuffer.Handle != NullHandle);
        ...
        protected override void SetupRenderPass()
        {
            ...
            attachments[0].samples = VkSampleCountFlags._1;                              // We don't use multi sampling in this example
            ...
            attachments[0].finalLayout = VkImageLayout.PresentSrc;                          // Layout to which the attachment is transitioned when the render pass is finished
        ...
        void preparePipelines()
        {
            ...
            fixed (byte* mainBytesPtr = mainBytes)
            {
                ...
                Debug.Assert(shaderStages[0].module.Handle != NullHandle);
                ...
                Debug.Assert(shaderStages[1].module.Handle != NullHandle);
            }
